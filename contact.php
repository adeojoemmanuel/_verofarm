					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 footer_contact">
								<h5>Get In Touch</h5>
								<ul class="list catagories">
		                            <li><a href="#"><i class="fa fa-envelope"></i>Veraloe@Veraloe.com</a></li>
		                            <li><a href="#"><i class="fa fa-phone"></i>+234 08149848925</a></li>
		                            <li><a href="#"><i class="fa fa-home"></i>Home office: Rice Republik Plaza, by Wazobia FM Bus stop, opposite NNPC filling station, Rumuosi, East-West Road, Port Harcourt.</a></li>
		                            <li><a href="#"><i class="fa fa-home"></i>Branch office: Okun's Palace, School of Nursing Road, Tombia, Ekpetiama Kingdom, Bayelsa State.</a></li>
		                        </ul>
