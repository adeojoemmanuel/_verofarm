		...
		<div class="main_page">
				...
				<div class="container">
					<nav class="menuzord pull-left" id="main_menu">
					   <ul class="menuzord-menu">
					      ...
					      <li><a href="about-us.php">Shop</a></li>
					       <!-- <li><a href="about-us.php">My account</a></li> -->
							...
							<ul>
								...
								<li data-index='rs-377' data-transition='curtain-1' data-slotamount='1' data-easein='default' data-easeout='default' data-masterspeed='default' data-thumb='images/home/slide-1.jpg' data-rotate='0' data-saveperformance='off' data-title='Business Solutions' data-description='' >
									...
									<div class="tp-caption tp-resizeme rs-parallaxlevel-2" 
										...
										<h5 class="cp-title">freshFish ~ Dryfish ~ fishfeeds ~ etc </h5>
									</div>
									...
									<div class="tp-caption tp-resizeme rs-parallaxlevel-2" 
										...
										data-responsive_offset="on" 
										style="z-index: 6; white-space: nowrap;">
										<h5 class="cp-title-2">We are providing highest quality Fish Products</h5>
									</div>
								...
								<li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/home/slide-2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Successful Careers" data-description="">
									...
									<div class="tp-caption tp-resizeme banner-caption-box"
					                    ...
					                    data-splitout="none"                         
					                    data-start="1000">
					                    <div class="banner-caption-h1">Get Discount <br>upto  50% Off</div>
					                    <div class="banner-caption-p"><p>get 50% discount when your other more than 50 kilo.</p></div>
					                    <a href="shop.php" class="thm-btn contuct-us">shop now</a>
					                </div>
								</li>
								...
								<li data-index="rs-20" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/home/slide-3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Your Success" data-description="">
					                ...
					                <div class="tp-caption tp-resizeme text-center"
					                    ...
					                    <a href="shop.php" class="color1-bg contuct-us">shop now</a>
					                </div>
								</li>
							</ul>	
						</div>
		        ...
		        <div class="container">
		            ...
		            <div class="filters text-center">
		                <ul class="filter-tabs filter-btns clearfix">
		                    ...
		                    <li class="filter" data-role="button" data-filter=".fresh"><span class="txt">fresh fish</span></li>
		                    <li class="filter" data-role="button" data-filter=".dry"><span class="txt">smoked fish</span></li>
		                    <li class="filter" data-role="button" data-filter="others"><span class="txt">dry fish</span></li>
		                    <li class="filter" data-role="button" data-filter=".feeds"><span class="txt">fish feeds</span></li>
		                </ul>
		            </div>
		            ...
		            <div class="row filter-list clearfix" id="MixItUp717B05">
			            ...
			            <!--Default Item-->
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all beauty fresh" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/1.jpg" alt=""><div class="product-model new">New</div></figure>
			                        <div class="content">
			            ...
			            <!--Default Item-->
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fresh" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/2.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <!--Default Item-->
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables fresh" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/3.jpg" alt=""><div class="product-model hot">Hot</div></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all beauty fresh" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/4.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <!--Default Item-->
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits dry" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/11.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <!--Default Item-->
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables beauty dry" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/12.jpg" alt=""><div class="product-model new">New</div></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits dry" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/13.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables beauty dry" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/14.jpg" alt=""><div class="product-model hot">Hot</div></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits feeds" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/21.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits feeds" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/22.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits feeds" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/23.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits feeds" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="images/farm/24.jpg" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.php">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="choose_us_item tran3s">
								...
								<div class="text float_left">
									<h5 class="tran3s">100% Fish product</h5>
			    ...
			    <div class="container">
			        ...
			        <div class="float_right">
			        	<div class="contact-box">
		                    ...
		                    <form method="post" action="http://steelthemes.com/demo/html/organic_store/sendemail.php" class="contact-form" novalidate="novalidate">
			...
			<footer>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 footer_contact">
								<h5>Get In Touch</h5>
								<ul class="list catagories">
		                            <li><a href="#"><i class="fa fa-home color1"></i>Home office: Rice Republik Plaza, by Wazobia FM Bus stop, opposite NNPC filling station, Rumuosi, East-West Road, Port Harcourt.</a></li>
		                            <li><a href="#"><i class="fa fa-home color1"></i>Branch office: Okun's Palace, School of Nursing Road, Tombia, Ekpetiama Kingdom, Bayelsa State.</a></li>
		                            <li><a href="#"><i class="fa fa-envelope color1"></i><span>Veraloe@Veraloe.com</span><br>Veraloe@Veraloe.com</a></li>
		                            <li><a href="#"><i class="fa fa-phone color1"></i>+234 08149848925<br>08149848925</a></li>
		                        </ul>
				...
				<div class="bottom_footer clear_fix">
					<div class="container">
						<h6 class="pull-left">Copyrights © 2015 All Rights Reserved by <a href="http://adeojoemmanuel.com" target="_blank"> iodevTech</a></h6>
